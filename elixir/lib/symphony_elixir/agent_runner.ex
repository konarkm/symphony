defmodule SymphonyElixir.AgentRunner do
  ...
  defp linear_agent_prompt(opts) do
    ...
    - Use `linear_update_issue_state` for semantic state handoffs. Do not change state just because the AgentSession started. For direct answers, planning discussion, or lightweight questions that do not begin task execution, emit the response activity and leave the issue state unchanged unless there is a clear reason to move it.
